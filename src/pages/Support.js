  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(rgba(11, 70, 25, 0.95), rgba(11, 70, 25, 0.95)), url("https://images.unsplash.com/photo-1557683311-eac922347aa1?q=80&w=2029&auto=format&fit=crop")',
          ...
          <div className='col-lg-4 mb-4 mb-lg-0'>
            ...
            <div className='mb-4'>
              ...
              <p className='text-primary ps-4 mb-0'>
                <a
                  href='mailto:support@pftpedu.org'
