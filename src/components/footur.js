        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          ...
          <div className=' flex flex-col items-start'>
            <div className='flex items-center gap-2'>
              <div className='hr-icon text-[15px] font-medium  uppercase'>
                {' '}
            ...
            <p className='mt-4 text-[#A8B5A2] text-start'>
              Empowering Minds, Transforming Futures – Your Journey to Knowledge
              Starts Here!
            </p>
          ...
          <div className='text-left'>
            ...
            <div className='grid grid-cols-2 gap-2 text-[#A8B5A2]'>
              {course.slice(0, 7).map((course, index) => (
                <p
                  onClick={() => {
          ...
          <div>
            ...
            <p className='text-[#A8B5A2] mb-4 text-start'>
              Subscribe to our newsletter to get more updates and join our
              course information.
            </p>
            <div className='flex'>
              <input
